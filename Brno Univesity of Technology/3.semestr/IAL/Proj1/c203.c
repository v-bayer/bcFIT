...
*/
	  ...
	  return (index + 1) % QUEUE_SIZE;  // Vrat index nasledujiciho prvku
...
*/
	  ...
	  return (q->f_index == q->b_index)? 1 : 0; // Jsou-li oba ukazatele na stejnem indexu, jedna se o prazdnou frontu
}
